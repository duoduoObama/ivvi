...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/common/http */ "./node_modules/@angular/common/fesm2015/http.js");
/* harmony import */ var csvtojson_converter__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! csvtojson-converter */ "./node_modules/csvtojson-converter/lib/csvtojson.js");
/* harmony import */ var csvtojson_converter__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(csvtojson_converter__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var ng_zorro_antd__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ng-zorro-antd */ "./node_modules/ng-zorro-antd/fesm2015/ng-zorro-antd.js");
...
let DashboardV1Component = class DashboardV1Component {
    constructor(http, cdr, msg, modalSrv) {
        this.http = http;
        this.cdr = cdr;
        this.msg = msg;
        this.modalSrv = modalSrv;
        ...
        this.loading = false;
        this.status = [
            { index: 0, text: '大融城', value: false, type: 'default', checked: false },
            {
                index: 1,
                text: '时代',
                value: false,
            ...
            { index: 2, text: '江津', value: false, type: 'success', checked: false },
            { index: 3, text: '永川', value: false, type: 'error', checked: false },
        ];
        this.columns = [
            { title: '', index: 'key', type: 'checkbox' },
            { title: '店铺', index: '店铺' },
            { title: '是否VIP', index: '是否VIP', format: data => `${data[`是否VIP`] || 'NO'}` },
            { title: '等级', index: '等级' },
            { title: '姓名', index: '姓名' },
            { title: 'VIP卡号', index: 'VIP卡号', format: data => `${data[`VIP卡号`] || 0}` },
            { title: 'QQ邮箱', index: 'QQ邮箱' },
            { title: '生日', index: '生日' },
            { title: '电话', index: '电话' },
            { title: '累计数量', index: '累计数量' },
            { title: '上年结余', index: '上年结余', format: data => `${data[`上年结余`] || 0}` },
            { title: '本年积分', index: '本年积分' },
            { title: '兑换', index: '兑换', format: data => `${data[`兑换`] || 0}` },
            { title: '剩余', index: '剩余' },
            {
                title: '操作',
                buttons: [
                    ...
                    {
                        text: '删除',
                        click: (item) => this.msg.success(`删除${item.no}`),
                    },
                ],
            },
        ];
    ...
    load() {
        return new Promise(resolve => {
            this.http.get('assets/ivviwork/ivvi.csv', { responseType: `text` }).subscribe(data => {
                const json = csvtojson_converter__WEBPACK_IMPORTED_MODULE_3__["csvToJson"](data);
                resolve(json);
            });
        });
    }
    getData() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            this.loading = true;
            this.data = yield this.load();
            console.log(this.q);
            if (this.q['电话'] || this.q['店铺'] || this.q['姓名']) {
                this.data = this.data.filter(cur => (this.q['电话'] == cur['电话']));
            }
            this.cdr.detectChanges();
            this.loading = false;
        });
...
], DashboardV1Component.prototype, "st", void 0);
...
module.exports = __webpack_require__(/*! F:\BaiduYunDownload\test\ng-alain-master\src\main.ts */"./src/main.ts");
